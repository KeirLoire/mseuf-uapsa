            			...
            			<div class="inner">
                        		...
                        		<div class="home leftcol">
                        			<div class="section-wrapper">
                            				<ul>
                                				<li onclick="selectHomeSection('announcements')" id="nav-section-announcements" class="selected">Announcements</li>
                                    				<li onclick="selectHomeSection('news')" id="nav-section-news" class="normal">News</li>
                                				<li onclick="selectHomeSection('events')" id="nav-section-events" class="normal">Events</li>
                                			</ul>
                                			<div class="clear"></div>
                                			<div id="home-announcements" class="section" style="display: block;">
                                				<div class="content">
                                    					<div class="announcement">
                                        					<div class="header">Creation of UAPSA Website</div>
                                			...
                                			<div id="home-news" class="section" style="display: none;">
                                  				<div class="content">
                                    					
                                    				</div>
                                				<div class="clear"></div>
                                			</div>
                                  			<div id="home-events" class="section" style="display: none;">
                                  				<div class="content">
